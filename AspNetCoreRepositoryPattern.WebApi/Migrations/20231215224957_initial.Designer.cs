...
namespace AspNetCoreRepositoryPattern.Migrations
{
    ...
    [Migration("20231215224957_initial")]
            ...
            modelBuilder.Entity("AspNetCoreRepositoryPattern.Models.Entities.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 12, 15, 23, 49, 56, 866, DateTimeKind.Local).AddTicks(8910),
                        ...
                        new
                        {
                            ...
                            Author = "James Joyce",
                            CreatedAt = new DateTime(2023, 12, 15, 23, 49, 56, 866, DateTimeKind.Local).AddTicks(8920),
            ...
            modelBuilder.Entity("AspNetCoreRepositoryPattern.Models.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 12, 15, 23, 49, 56, 866, DateTimeKind.Local).AddTicks(8950),
                            DateOfBirth = new DateTime(2023, 12, 15, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 12, 15, 23, 49, 56, 866, DateTimeKind.Local).AddTicks(8960),
                            DateOfBirth = new DateTime(2023, 12, 15, 23, 49, 56, 866, DateTimeKind.Local).AddTicks(8960),
            ...
            modelBuilder.Entity("AspNetCoreRepositoryPattern.Models.Entities.Todo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 12, 15, 23, 49, 56, 866, DateTimeKind.Local).AddTicks(8770),
                            Done = true,
                            Name = "Shopping"
                        },
                        new
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 12, 15, 23, 49, 56, 866, DateTimeKind.Local).AddTicks(8780),
                            Done = true,
                            Name = "Coding"
                        },
                        new
            ...
            modelBuilder.Entity("AspNetCoreRepositoryPattern.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 12, 15, 23, 49, 56, 866, DateTimeKind.Local).AddTicks(8980),
